...
OBJECTS= ./build/misc.o ./build/lexer.o ./build/parser.o ./build/scope.o ./build/codegen.o ./build/helpers/vector.o ./build/helpers/buffer.o ./build/compiler.o ./build/cprocess.o
all: ${OBJECTS}
